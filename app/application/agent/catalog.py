            ...
            Tool(
                ToolSpec(
                    ...
                    description=(
                        ...
                        "Вызывай для общих вопросов вроде 'какие свободные смены есть', 'есть ли свободные смены', "
                        "'кто свободен на смену'. Для полного списка направь пользователя в /shift."
                    ),
                    parameters=_NO_ARGS,
                ),
